    ...
    return (
      <div>
        ...
        <ol className='ListInstructions'>
          ...
          </li><li>Enter <Credential tag={'server'}/>_VPN_SERVER_ in the <strong>Internet address</strong> field.
          </li><li>Enter anything you like in the <strong>Destination name</strong> field.
          </li><li>Check the <strong>Do not connect now; just set it up so I can connect later</strong> checkbox.
          </li><li>Click <strong>Next</strong>.
          </li><li>Enter <Credential tag={'user'}/> in the <strong>User name</strong> field.
          </li><li>Enter <Credential tag={'pass'}/> in the <strong>Password</strong> field.
          ...
          </li><li>Select <strong>Use preshared key for authentication</strong> and enter <Credential tag={'psk'}/> for the <strong>Key</strong>.
          ...
          </li><li>Note: This <a href="https://github.com/hwdsl2/setup-ipsec-vpn/blob/master/docs/clients.md#windows-error-809">one-time registry change</a> is required if the VPN server and/or client is behind NAT (e.g. home router).
          </li><li>To connect to the VPN, click on the wireless/network icon in your system tray, select the new VPN entry, and click Connect.
          </li><li>If prompted, enter Your VPN Username <Credential tag={'user'}/> and Password <Credential tag={'pass'}/>, then click OK.
          You can verify that your traffic is being routed properly by looking up your IP address on Google.
          It should say "Your public IP address is " <Credential tag={'server'}/>
          </li><li>If you get an error when trying to connect, see <a href="https://github.com/hwdsl2/setup-ipsec-vpn/blob/master/docs/clients.md#troubleshooting">Troubleshooting</a>.
          </li>
        </ol>
        <hr className="my-4"/>
      </div>
