  ...
  render() {
    return (
      <div className="jumbotron">
        ...
        <hr className="my-4"/>
        <p>If a file does not start to download shortly, please follow the manual setup guide below</p>
          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="exampleModalLabel">Execute the downloaded .mobileconfig file</h5>
                <button type="button" className="close" data-dismiss="modal" aria-label="Close">
                  <span aria-hidden="true">&times;</span>
                </button>
              </div>
              <div className="modal-body">
                <img className="modal-image" id="image" alt="Please execute the downloaded file" src={dappnodeExecuteInstruccion}/>
              </div>
            </div>
          </div>
        </div>
