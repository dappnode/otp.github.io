    ...
    return (
      <div>
        ...
        <ol className='ListInstructions'>
          <li>If you have not already, sign in to your Chromebook.
          ...
          </li><li>Enter <Credential tag={'server'}/> for the <strong>Server hostname</strong>.
          ...
          </li><li>Enter <Credential tag={'psk'}/> for the <strong>Pre-shared key</strong>.
          </li><li>Enter <Credential tag={'user'}/> for the <strong>Username</strong>.
          </li><li>Enter <Credential tag={'pass'}/> for the <strong>Password</strong>.
