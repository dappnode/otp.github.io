    ...
    return (
      <div>
        ...
        <ol className='ListInstructions'>
          ...
          </li><li>Enter <Credential tag={'server'}/> in the <strong>Server address</strong> field.
          </li><li>Enter <Credential tag={'psk'}/> in the <strong>IPSec pre-shared key</strong> field.
          </li><li>Tap <strong>Save</strong>.
          </li><li>Tap the new VPN connection.
          </li><li>Enter <Credential tag={'user'}/> in the <strong>Username</strong> field.
