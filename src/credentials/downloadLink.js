...
function downloadLinkSupported() {
  document.getElementById("downloadLink").innerHTML =
    ...
    '<button className="btn" onclick="downloadMobileConfig()" className="mobileConfig_DL">DOWNLOAD</button>' +
...
function downloadLinkForSafari() {
  ...
  +'<button className="btn" onclick="downloadMobileConfig()" id="btn_DL">DOWNLOAD</button>';
}
